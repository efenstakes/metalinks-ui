...
import ProfileLoadingPage from '../../me/loading_state'
...
const bgImage = '../../../public/images/face-big.png'
const CONTRACT_ADDRESS = '0xA6C7382372ca0e8122D052dC61b4f3e45ADd79da'
const AvatarPage = ({params: { id }}: { params: { id: string } }) => {
    console.log("router ", id)
  
    return <Profile address={id} />
}
